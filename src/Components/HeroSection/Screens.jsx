...
import img1 from "../../assets/Screens/image (1).svg";
import img2 from "../../assets/Screens/image (2).svg";
import img3 from "../../assets/Screens/image (3).svg";
import img4 from "../../assets/Screens/image (4).svg";
import img5 from "../../assets/Screens/image (5).svg";
import img6 from "../../assets/Screens/image.svg";
import ra from "../../assets/Arial.jpg";
const Screens = () => {
  return (
    <section className="container px-8 mx-auto py-5">
      <div className="w-full flex items-center justify-between  p-5">
        <h5 className="font-bold text-lg text-[#000E39]">أجهزة اللاب توب</h5>
